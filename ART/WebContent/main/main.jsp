...
<html>
   <head>
    ...
    <title>Awesome Graffiti Art WebSite - Come and </title>
  ...
  <body>
    ...
    <!-- Hero Section-->
    <section style="background: url(/ART/main/img/main222.jpg); background-size: cover; background-position: center center" class="hero">
      <div class="container">
        <div class="row">
          <div class="col-lg-7">
            <h1>Awesome Graffiti Art - Beautiful Street Artworks </h1><a href="#" class="hero-link">Discover More</a>
          </div>
