        ...
        <!-- Widget [Tags Cloud Widget]-->
          ...
          <div class="widget search">
            ...
            <form action="m_list.do" class="search-form">
            	<% 
            		String kindVal = request.getParameter("kind");
            		kindVal = kindVal == null ? "" : kindVal;
            	%>
            	
           	  <div class="form-group" style="padding-bottom:4px;">
	           	<select  name="kind" style="margin-right:10px; border: 0px solid #999; color:#444; font-size:14px;">
	              	<option vlaue="">모든주제</option>
	              	<option value="해외작품">해외작품</option>
	              	<option value="국내작품">국내작품</option>
	              	<option value="국내전시">국내전시</option>
					<option value="인원모집">인원모집</option>
             	 </select>
           	  </div>
          ...
          <div class="widget latest-posts">
			...
			<c:forEach var="dto1" items="${LG1}">
              <a href="g_detail.do?Gidx=${dto1.getUserid()}&Mnum=${dto1.getM_num()}">
                <div class="item d-flex align-items-center">
	              	<div class="circle sideImg">
			      		<div style="background-image:url(/ART/storage/${dto1.getM_file()})"></div>
			      	</div>
                  
                  <div class="title">
                     <div style="height:32px; overflow:hidden;">
                       <strong>${dto1.getM_title()}</strong>
                     </div>
                    <div class="d-flex align-items-center">
                      <div class="views"><i class="icon-eye"></i>${dto1.m_hit}</div>
                      <div class="comments"><i class="icon-comment"></i>${dto1.getM_replynum()}</div>
                    </div>
                  </div>
                </div>
            </a>
          ...
          <div class="widget categories" >
            ...
            <div class="item d-flex justify-content-between" id="kindsort">
